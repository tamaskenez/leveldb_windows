...
namespace winapi {
  namespace detail {
    //this is needed because DeleteFile is a macro which must be undefined for other files that include this one
    inline BOOL Call_DeleteFile(_In_  LPCTSTR lpFileName) {
...
namespace winapi {
  //These are normal functions, not macros. They're
  //written with capital letters to stand out from 'normal'
